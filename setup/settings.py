...
# Database
# Configuração dinâmica: PostgreSQL para produção (se variáveis existirem) e SQLite para fallback local.
if env('DB_NAME', default=None) and env('DB_USER', default=None):
    DATABASES = {
        'default': {
